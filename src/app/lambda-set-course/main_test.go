...
func makeRequest(event SetCourseEvent, mockGameState models.Game) (SetCourseResponse, error) {
	var responseTyped SetCourseResponse
	...
	responseTyped, ok := response.(SetCourseResponse)
	if ok == false {
